...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2017 a las 17:58:50
...
(1, 'USU1510998510', '$2y$10$ZK8I4dNn7iA4SecquG33eerICLEmOVCvNBCaA2IpmLnHY/z6Kd6uG', 7, 'offline'),
(3, 'USU1511003296', '$2y$10$mjUUzMc0BinuNANJhcGQxOXKgMNsL317lBtjztdn3jRgoTYuk82D6', 0, 'offline');
...
CREATE TABLE `pdc` (
  ...
  `pdc_latitud` float NOT NULL,
  `pdc_longitud` float NOT NULL,
  `pdc_estado` tinyint(1) NOT NULL,
  `pdc_telefono` int(11) DEFAULT NULL,
  `pdc_celular` int(11) DEFAULT NULL,
  `pdc_fech_creacion` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, '8464228', 1, 'La perrera', 'Clle 70 60-11', '10:00:00.00000', '20:00:00.00000', 6.16757, -75.6147, 1, 2472345, 2147483647, '2017-11-18 10:57:29');
...
(1, 'RESTAURANT', 'Never description');
...
('USU1510998510', 'Fredy Albeto', 'Fredy Albeto', 'falujan8@misena.edu.co'),
('USU1511003296', 'Adriana', 'Escobar', 'adrianalep@hotmail.com');
...
--
ALTER TABLE `access`
  MODIFY `acc_token` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
