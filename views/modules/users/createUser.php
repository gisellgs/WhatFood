    ...
    <div class="col m4 offset-m4 blue-grey lighten-5">
        <div class="row">
            ...
            <form action="guardar-visitante" id="frmLoginVisitor" method="post" data-parsley-validate>
                ...
                <div class="input-field col s12">
                    <label for="txtemailNew"> <i class="fa fa-envelope" aria-hidden="true"></i> Correo Electronico</label>
                    <input  id="txtemailNew" type="email" class="validate" name="data[]" required="required" value="falujan8@misena.edu.co">
                </div>
